...
Pour clôturer ce chapitre, je vous propose le code suivant qui permet d'améliorer celui présenté dans le [chapitre sur la généricité](https://blog.guillaume-gomez.fr/blog/2/4.png) grâce à une macro :
...
Je tiens cependant encore à précisé que nous n'avons vu ici que la base des macros : elles permettent de faire des choses nettement plus impressionnantes (certaines crates le démontrent d'ailleurs fort bien).
