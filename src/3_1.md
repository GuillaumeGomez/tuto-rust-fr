...
Je vous avais présenté les **macros** dans un chapitre précédent. Cependant, elles sont vite limitées et compliquées dès que la complexité de ce qu'on souhaite faire augmente. Pour pallier à ce problème, les **proc-macros** ont été créées. D'ailleurs, vous vous en êtes déjà servies sans le savoir :
