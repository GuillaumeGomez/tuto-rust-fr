...
Les __supertraits__ (en un seul mot) sont des traits qui sont requis pour l'implémentation d'un trait :

```Rust
trait Machine {}

// On ajoute un supertrait "Machine" à " Car ".
trait Car: Machine {}
...
Autre information intéressante, le trait peut utiliser les objets définis dans le supertrait dans ses implémentations par défaut :
