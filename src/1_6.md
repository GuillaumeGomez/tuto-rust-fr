...
Expliquons rapidement ce qu'est ce __()__ : c'est un __tuple__ vide. __tuple__ est une structure de donnée qui a un nombre d'élements définis et dont les types peuvent différer. Ils sont utiles si l'on souhaite retourner plusieurs valeurs d'un coup :
