...
C++ ne possède pas d'outil officiel (bien qu'il en existe un certain nombre) pour gérer un projet et ses dépendances. Parmi les outils les plus connus, il y a `Makefile` et `CMake`, mais aucun des 2 ne gèrent le téléchargement des dépendances.
