...
Il est aussi possible de matcher directement sur un ensemble de valeurs avec le __@__ de cette façon :
...
match i {
    ...
    x => println!("{} n'est pas entre 9 et 101")
};
```

Pratique ! Il ne nous reste maintenant plus qu'un dernier point à aborder :
