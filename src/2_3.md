...
J'en profite maintenant pour vous montrer quelques utilisations de traits comme [__Range__] (que l'on avait déjà rapidement abordé dans le chapitre des boucles). Ce dernier peut vous permettre de faire :
