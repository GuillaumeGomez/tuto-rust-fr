 ...
 * __tt__ : un élément un peu plus global, il peut contenir toute une expression. Il y a peu de chances que vous vous en serviez un jour.
...
Dans le cas présent, on récupère le tout dans un slice qu'on récupère en le transformant en Vec. On pourrait aussi afficher tout les arguments un par un :
