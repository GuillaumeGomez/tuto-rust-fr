...
Si vous utilisez __Cargo__, il est aussi possible d'écrire des tests dans un dossier à part. Commencez par créer un dossier __tests__ puis créez un fichier .rs.
