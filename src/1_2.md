...
Ou bien un éditeur de texte. Il existe actuellement un éditeur de texte spécialement conçu pour Rust, disponible pour les systèmes GNU/Linux et MacOS : [SolidOak](https://sekao.net/solidoak/).
