...
En bref : pas de parenthèses autour de la condition mais accolades obligatoires autour du bloc associé à la condition.
...
Il est bien évidemment possible de matcher plus d'une valeur à la fois, pas besoin d'écrire toutes les valeurs en dessous de 18 pour voir s'il est mineur. Dans le cas ci-dessus, le mieux serait d'écrire :
